...
mod tests {
    ...
    fn arr_leaf_with_nested_arr() {
        let data = [
            ...
            0x03, 0x00, // bitmap: 0x0003 (slots 0,1)
            0x02, 0x00, 0x00, 0x00, // length: 2
            0xD1, 0x14, // value 0: arr (packed, 1 byte), offset=0x14 (20)
            0xD1, 0x30, // value 1: arr (packed, 1 byte), offset=0x30 (48)
            ...
            0x40, 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // i64(42)
            ...
            0x01, 0x00, // bitmap: 0x0001 (slot 0)
            0x01, 0x00, 0x00, 0x00, // length: 1
            0x40, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // i64(99)
            0x00, 0x00, 0x00, // padding to 4-byte boundary
        ];
    ...
    fn map_leaf_with_entries() {
        let data = [
            ...
            0x91, 0x61, // txt "a" (packed, len=1)
            0x40, 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // i64(42)
            // entry 1: key="b", value=i64(99)
            0x91, 0x62, // txt "b" (packed, len=1)
            0x40, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // i64(99)
    ...
    fn map_leaf_with_nested_map() {
        let data = [
            ...
            0x95, 0x69, 0x6E, 0x6E, 0x65, 0x72, // txt "inner" (packed, len=5)
            0xF1, 0x14, // map (packed, 1 byte), offset=0x14 (20)
            0x00, 0x00, 0x00, 0x00, // padding to reach offset 0x14
            // Child map leaf at offset 0x14 (20): {"x": 123}
            0x17, 0x00, 0x00, 0x00, // header: node_len=20, leaf=1, map=1
            0x01, 0x00, 0x00, 0x00, // entry_count: 1
            0x91, 0x78, // txt "x" (packed, len=1)
            0x40, 0x7B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // i64(123)
